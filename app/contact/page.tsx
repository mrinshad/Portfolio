              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="editorial-input text-lg font-medium text-foreground placeholder:text-muted-foreground/50"
                  />
                  {errors.name && (
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="editorial-input text-lg font-medium text-foreground placeholder:text-muted-foreground/50 resize-none"
                  />
                  {errors.message && (
